...
asn_TYPE_member_t asn_MBR_CertManagementPdu_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, choice.multiSignedCtl),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, choice.tbsCtlSignature),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CertManagementPdu, choice.infoStatus),
