...
asn_TYPE_member_t asn_MBR_ChannelNodeStatusContainer_1[] = {
	{ ATF_POINTER, 1, offsetof(struct ChannelNodeStatusContainer, auxilliaryLinkMac),
...
static const int asn_MAP_ChannelNodeStatusContainer_oms_1[] = { 0 };
...
static const asn_TYPE_tag2member_t asn_MAP_ChannelNodeStatusContainer_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cpuLoad */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ramLoad */
};
