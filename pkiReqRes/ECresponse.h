...
#ifndef EC_RESPONSE_H
#define EC_RESPONSE_H
...
public:
    ...
    ECResponse(); // Costruttore
    virtual ~ECResponse(); // Distruttore
...
private:
    ...
    // RFC5480 keys loaded from PKI_info.ini (section [ECinfo])
    std::string m_public_key_rfc;
    std::string m_private_key_rfc1;
    std::string m_private_key_rfc2;
};
